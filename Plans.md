...
- [x] Complete the Asset Forge v1 engine `cc:v1技術実装の記録／Fable5前提不足（2026-07-13）`
...
- [x] Complete independent distribution and security review `cc:旧v1差分の審査記録（2026-07-13）`
